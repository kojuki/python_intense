...
#По этому множеству будет проверяться количество вхождений чисел в начальный список. Раскоментировать строку 70 для ознакомления с разницей список-множество.
#print('Содержимое множества: ', set(List_1))
